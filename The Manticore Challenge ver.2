...
for (int currentRound = 1; currentRound <= 20; currentRound++)
{
    ...
    {
        Console.WriteLine("YOU HAVE WON!"); // Need a way to stop the application once the manticore is destroyed *UPDATE* IT works now!*
        VictoryCall();
        break;
    }
...
void VictoryCall()
{
    Console.WriteLine("Congratulations! you have prevailed!");
}
